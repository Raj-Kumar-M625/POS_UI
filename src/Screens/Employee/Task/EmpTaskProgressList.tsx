...
export const EmpTaskProgressList = () => {
  ...
  const sessionUaser = JSON.parse(json);
  ...
  useEffect(() => {
    let projectList = Get(
      `app/EmployeeDailyTask/GetEmployeeTimePlanList?employeeId=${sessionUaser.employeeId}`
    );
    let projList = Get("app/Project/GetEmployeeProjectlist");
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setfilter((prevState: any) => ({
                    ...prevState,
                    employeename:
                      alphabeticValue === "" ? null : alphabeticValue,
                  }));
                }}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <Select
                ...
                onChange={(code: any) => {
                  if (code) {
                    setfilter((prevState: any) => {
                      return { ...prevState, status: code.value };
                    });
                  }
                }}
                options={[
